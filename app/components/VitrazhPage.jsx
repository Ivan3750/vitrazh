...
export default function VitrazhPage() {
  return (
    <>
      ...
      {/* --- ПЕРШИЙ СЛАЙДЕР --- */}
      <section className="px-6 py-12 max-w-6xl mx-auto">
        <h2 className="mb-8 text-center text-5xl">Класичні вітражі</h2>
      ...
      {/* ТРИ ВИДИ ВІТРАЖІВ */}
      <section className="px-6 py-12 max-w-6xl mx-auto">
        <h2 className="mb-8 text-center text-5xl">Види вітражів</h2>
      ...
      {/* --- ДРУГИЙ СЛАЙДЕР --- */}
      <section className="px-6 py-12 max-w-6xl mx-auto">
        <h2 className="mb-8 text-center text-5xl">Діамантова грань</h2>
        <Swiper
          modules={[Autoplay, Pagination, Navigation]}
          autoplay={{ delay: 4000 }}
          pagination={{ clickable: true }}
      ...
      {/* --- ТРЕТІЙ СЛАЙДЕР --- */}
      <section className="px-6 py-12 max-w-6xl mx-auto">
        <h2 className="mb-8 text-center text-5xl">Кришталеві елемети</h2>
      ...
      <section className="px-6 py-12 max-w-4xl mx-auto text-center">
        <h2 className="text-2xl mb-4 ">Декоративна довершеність</h2>
        <p className="text-lg text-gray-700 leading-relaxed">
