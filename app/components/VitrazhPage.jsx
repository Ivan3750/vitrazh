...
export default function VitrazhPage() {
  return (
    <>
      {/* HERO */}
      ...
      {/* --- ПЕРШИЙ СЛАЙДЕР --- */}
      <section className="px-6 py-12 max-w-6xl mx-auto">
        <h3 className="text-3xl font-semibold mb-8 text-center">Класичні вітражі</h3>
      ...
      {/* ТРИ ВИДИ ВІТРАЖІВ */}
      <section className="px-6 py-12 max-w-6xl mx-auto">
        <h3 className="text-3xl font-semibold mb-8 text-center">Види вітражів</h3>
      ...
      {/* --- ДРУГИЙ СЛАЙДЕР --- */}
      <section className="px-6 py-12 max-w-6xl mx-auto">
        <h3 className="text-3xl font-semibold mb-8 text-center">Діамантова грань</h3>
        <Swiper
          modules={[Autoplay, Pagination, Navigation]}
          autoplay={{ delay: 4000 }}
          pagination={{ clickable: true }}
      ...
      {/* --- ТРЕТІЙ СЛАЙДЕР --- */}
      <section className="px-6 py-12 max-w-6xl mx-auto">
        <h3 className="text-3xl font-semibold mb-8 text-center">Кришталеві елемети</h3>
